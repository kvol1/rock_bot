...
async def process_yes_answer(message: Message):
    await message.answer(text = LEXICON_RU, reply_markup=game_kb)
...
def register_user_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(process_game_button, Text(equals=[LEXICON_RU['rock'], LEXICON_RU['paper'], LEXICON_RU['scissors']]))